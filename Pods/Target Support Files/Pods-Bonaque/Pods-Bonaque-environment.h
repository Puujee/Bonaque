...
// ATLog
#define COCOAPODS_POD_AVAILABLE_ATLog
#define COCOAPODS_VERSION_MAJOR_ATLog 0
#define COCOAPODS_VERSION_MINOR_ATLog 0
#define COCOAPODS_VERSION_PATCH_ATLog 2
